  ...
  static List<UnitModel> _getChapter1Units() {
    return [
      UnitModel(
        ...
        objectiveMyanmar: 'အလယ်သံဗျည်း ၃ လုံးဖြစ်သော ก, จ, ด တို့၏ အသံထွက်ကို လေ့လာပါ။',
        scriptItems: const [
          ScriptModel(
            symbol: 'ก',
            nameThai: 'ก ไก่',
  ...
  static List<UnitModel> _getChapter2Units() {
    return [
      UnitModel(
        ...
        objectiveMyanmar: 'မင်္ဂလာပါ၊ ခင်ဗျာ၊ ရှင် စသည့် ယဉ်ကျေးသော စကားလုံးများကို လေ့လာပါ။',
        scriptItems: const [],
        vocabulary: const [
          VocabularyModel(
            id: 'v_sawasdee',
